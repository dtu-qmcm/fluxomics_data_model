...
edge2fl=c("d.n.R1", "d.n.R2", "f.n.R3", "d.n.R4", "d.n.R4", "d.n.R4", "d.n.R5", "d.n.R5", "d.n.R5", "d.n.R5", "d.n.R5", "d.n.R6", 
"f.n.E_out", "f.n.F_out")
...
nm_fln=c("d.n.R1", "d.n.R2", "d.n.R4", "d.n.R5", "d.n.R6")
nb_fln=length(nm_fln)
fln=c(99.9999999999999, 109.99999999999997, 20.000000000000057, 20.0, 79.99999999999997)
names(fln)=nm_fln
...
if (nb_fl) {
   Afl=matrix(0, nrow=nb_flr, ncol=nb_fl)
       Afl[1, c(1, 2, 3, 4)]=c(1.0, -1.0, -1.0, -1.0)
           Afl[2, c(2, 4, 5)]=c(1.0, 1.0, -1.0)
           Afl[3, c(3, 4)]=c(1.0, -1.0)
           Afl[4, c(3, 4)]=c(1.0, 2.0)
           Afl[5, c(5)]=c(1.0)
        } else {
...
# free net fluxes
nb_ffn=3
nm_ffn=c("f.n.E_out", "f.n.F_out", "f.n.R3")
# starting values for iterations
param=c(param, c(60.0, 80.0, 50.0))
if (nb_ffn) {
...
p2bfl[1, pmatch(c("f.n.R3"), nm_par)]=c(-1.0);

p2bfl[2, pmatch(c("f.n.R3"), nm_par)]=c(1.0);

p2bfl[4, pmatch(c("f.n.E_out"), nm_par)]=c(1.0);

p2bfl[5, pmatch(c("f.n.F_out"), nm_par)]=c(1.0);
...
if (!noscale) {
   ...
   param=c(param,1)
   nm_par=c(nm_par,c("1:mass;F;111;108"))
   names(param)=nm_par
